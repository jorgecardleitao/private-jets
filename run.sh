AWS_ACCESS_KEY_ID=2F2QDZJ5AK8ZSFA1NAZW
...
# https://private-jets.fsn1.your-objectstorage.com/position/icao_number={icao}/month={year}-{month}/data.json
...
# they are available at
# https://private-jets.fsn1.your-objectstorage.com/leg/v1/data/icao_number={icao}/month={year}-{month}/data.csv

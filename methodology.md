...
### M-emissions-private-jet: Emissions of a private jet over a leg

This was performed automatically by the program and consisted in the following calculation:
...
* `leg time [h]` is obtained by computing duration of the leg, as identified via the methodology `M-identify-legs` in this document.
